...
class LottoEngine:
    ...
    def generate_single_combination(game, use_filters=False, even_odd_ratio=None, min_sum=None, max_sum=None, custom_pool=None):
        ...
        for _ in range(500): # رفع عدد محاولات الفحص لضمان مطابقة الفلاتر الصارمة
            ...
            if use_filters:
                ...
                if min_sum is not None and max_sum is not None:
                    ...
                    if not (int(min_sum) <= total_sum <= int(max_sum)):
                        continue
...
if st.session_state["user_plan"] == "free":
    ...
    with col1:
        ...
        # 🟢 [تحديث جوهري]: تغيير خيارات الفردي والزوجي تلقائياً بناءً على عدد أرقام اللعبة المحددة
